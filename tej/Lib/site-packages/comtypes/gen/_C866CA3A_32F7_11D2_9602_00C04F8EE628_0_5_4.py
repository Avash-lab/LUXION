...
__all__ = [
    'SDA_One_Trailing_Space', 'SVEPhoneme', 'SPINTERFERENCE_TOOLOUD',
    'SGDSActiveWithAutoPause', 'SpeechDataKeyLocation',
    'DISPID_SRSetPropertyNumber', 'DISPID_SpeechAudioStatus',
    'SPCS_DISABLED', 'ISpStream', 'SpeechPropertyResourceUsage',
    'SpObjectTokenCategory', 'DISPID_SRCEInterference',
    'SPRECOCONTEXTSTATUS', 'SDTLexicalForm', 'SVSFVoiceMask',
    'eLEXTYPE_RESERVED7', 'DISPID_SVEEnginePrivate',
    'DISPID_SAEventHandle', 'SRAORetainAudio', 'DISPID_SOTDisplayUI',
    'ISpStreamFormat', 'UINT_PTR', 'SREPhraseStart',
    'SpeechDiscardType', 'SAFT16kHz8BitMono', 'SRCS_Enabled',
    'SAFTText', 'DISPID_SpeechGrammarRule', 'DISPID_SVSpeakStream',
    'SVPAlert', 'DISPID_SPAs_NewEnum', 'DISPID_SRAudioInput',
    'SPEI_TTS_BOOKMARK', 'SpeechGrammarRuleStateTransitionType',
    'DISPID_SOTGetStorageFileName', 'DISPID_SpeechVoiceEvent',
    'ISpPhoneConverter', 'DISPID_SRCAudioInInterferenceStatus',
    'SpeechPropertyNormalConfidenceThreshold', 'SPPHRASE',
    'SpeechVoiceSpeakFlags', 'SFTInput', 'SGRSTTRule',
    'ISpNotifySource', 'eLEXTYPE_PRIVATE11', 'SPEI_MAX_SR',
    'SDA_Consume_Leading_Spaces', 'SVP_3', 'DISPID_SGRsAdd',
    'DISPID_SRCEAdaptation', 'ISpeechAudioBufferInfo', 'SVF_Emphasis',
    'SDTPronunciation', 'DISPID_SpeechCustomStream',
    'DISPID_SPRulesItem', 'SSTTTextBuffer', 'DISPID_SVGetAudioInputs',
    'SpeechMicTraining', 'DISPID_SRCBookmark', 'SREStreamEnd',
    'DISPID_SRRTLength', 'DISPID_SPEAudioTimeOffset', 'SRARoot',
    'DISPID_SRGRecoContext', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'SREAllEvents', 'DISPID_SPPsItem', 'DISPID_SGRClear',
    'DISPID_SRRDiscardResultInfo', 'SVSFParseSapi',
    'DISPID_SPPParent', 'SPEI_MAX_TTS',
    'DISPID_SLAddPronunciationByPhoneIds', 'typelib_path',
    'SDTProperty', 'DISPIDSPTSI_ActiveOffset', 'DISPID_SLWsItem',
    'SREBookmark', 'SGSExclusive', 'DISPID_SVSInputWordLength',
    'DISPID_SpeechLexicon', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'SAFTGSM610_22kHzMono', 'SSFMCreateForWrite',
    'SPINTERFERENCE_NOISE', 'DISPID_SPCPhoneToId',
    'SPFM_CREATE_ALWAYS', 'SpeechTokenKeyAttributes', 'SRTStandard',
    'DISPID_SpeechRecognizer', 'DISPID_SPISaveToMemory',
    'DISPID_SPEsItem', 'DISPID_SpeechLexiconProns',
    'SAFT24kHz8BitStereo', 'DISPID_SVEStreamEnd',
    'DISPID_SAFGetWaveFormatEx', 'SPAO_NONE', 'SP_VISEME_21',
    'SRCS_Disabled', 'ISpRecognizer', 'SPPARTOFSPEECH',
    'ISpeechGrammarRuleStateTransition',
    'DISPID_SpeechGrammarRuleState', 'DISPID_SLGenerationId',
    'SPCATEGORYTYPE', 'SAFT48kHz16BitStereo',
    'DISPID_SPPBRestorePhraseFromMemory',
    'SpeechStreamSeekPositionType', 'DISPID_SVSyncronousSpeakTimeout',
    'DISPIDSPTSI_ActiveLength', 'SAFT11kHz16BitStereo',
    'DISPID_SpeechPhraseReplacements', 'DISPID_SVDisplayUI',
    'ISpeechXMLRecoResult', 'DISPID_SLGetGenerationChange',
    'SPEI_SR_PRIVATE', 'SP_VISEME_6', 'SPAS_STOP', 'SPCT_DICTATION',
    'SAFT22kHz16BitMono', 'SWPUnknownWordUnpronounceable',
    'SpShortcut', 'eLEXTYPE_RESERVED9', 'SPBOOKMARKOPTIONS',
    'SVSFNLPMask', 'ISpRecoContext', 'DISPID_SpeechRecognizerStatus',
    'SpLexicon', 'STSF_AppData', 'DISPID_SABIMinNotification',
    'DISPID_SRCSetAdaptationData', 'ISpPhraseAlt', 'SVSFPersistXML',
    'ISpRecoResult', 'SINone', 'DISPID_SPRs_NewEnum', 'SP_VISEME_9',
    'ISpPhoneticAlphabetConverter', 'SAFT8kHz16BitStereo',
    'DISPID_SRSSupportedLanguages', 'DISPID_SDKDeleteValue',
    'DISPID_SPEAudioSizeBytes', 'SPLOADOPTIONS', 'SpResourceManager',
    'DISPID_SFSOpen', 'SGRSTTWildcard', 'DISPID_SRRSaveToMemory',
    'SPSHORTCUTPAIR', 'ISpeechLexiconWord', 'SP_VISEME_3',
    'ISpeechPhraseAlternate', 'ISpeechPhraseElements', 'SPRULESTATE',
    'SAFTCCITT_uLaw_22kHzStereo', 'SPEI_SR_RETAINEDAUDIO',
    'SPEI_SOUND_END', 'DISPID_SPPId', 'SpTextSelectionInformation',
    'DISPID_SRCEStartStream', 'SVSFNLPSpeakPunc',
    'SAFT44kHz16BitMono', 'SPRST_NUM_STATES', 'SpeechVoiceEvents',
    'SAFTCCITT_uLaw_11kHzStereo', 'DISPID_SPPFirstElement',
    'eLEXTYPE_PRIVATE8', 'SPEI_TTS_AUDIO_LEVEL', 'SpeechLoadOption',
    'SAFT24kHz16BitMono', 'SAFT48kHz8BitStereo',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet', 'SASPause',
    'SVSFIsFilename', 'DISPID_SMSAMMHandle',
    'SpeechPropertyComplexResponseSpeed', 'SPCT_SUB_COMMAND',
    'SPVISEMES', 'DISPID_SPIGetText', 'SPSMF_SRGS_SAPIPROPERTIES',
    'DISPID_SPCLangId', 'eLEXTYPE_RESERVED8', 'SVP_19',
    'DISPID_SRGSetTextSelection', 'DISPID_SRCEEnginePrivate',
    'DISPIDSPRG', 'SAFTADPCM_22kHzStereo', 'SP_VISEME_0',
    'SAFT44kHz8BitStereo', 'DISPID_SpeechMemoryStream',
    'SPSInterjection', 'DISPID_SPEAudioSizeTime',
    'SpPhoneticAlphabetConverter', 'SAFT44kHz8BitMono',
    'ISpPhoneticAlphabetSelection', 'SVSFParseMask',
    'DISPID_SGRsCommit', 'SpeechPartOfSpeech', 'SPFM_NUM_MODES',
    'SPPHRASEPROPERTY', 'DISPID_SpeechPhraseAlternate',
    'DISPID_SRGDictationSetState', 'DISPID_SRSCurrentStreamNumber',
    'SPEI_VISEME', 'DISPID_SGRName', 'ISpVoice',
    'SAFTCCITT_ALaw_8kHzMono', 'DISPID_SGRSTPropertyName',
    'SPBO_TIME_UNITS', 'SECFEmulateResult', 'ISpeechCustomStream',
    'DISPID_SRGCmdSetRuleIdState', 'SpeechAudioFormatGUIDWave',
    'SAFTADPCM_8kHzMono', 'SAFT22kHz8BitMono', 'SASStop',
    'SECFIgnoreKanaType', 'DISPID_SpeechObjectTokenCategory',
    'SRSInactive', 'SGDSActive', 'DISPID_SOTRemoveStorageFileName',
    'DISPID_SRCEPropertyStringChange', 'DISPID_SPIReplacements',
    'SPDKL_LocalMachine', 'SPPS_RESERVED1', 'ISpeechRecoGrammar',
    'eLEXTYPE_RESERVED4', 'SPAUDIOBUFFERINFO', 'DISPID_SpeechDataKey',
    ...
    'DISPID_SPPChildren', 'DISPID_SGRs_NewEnum', 'SAFT11kHz16BitMono',
    'SAFT32kHz16BitStereo', 'DISPID_SPPEngineConfidence',
    'SpStreamFormatConverter', 'SDTAudio', 'SpSharedRecognizer',
    'SPAUDIOSTATUS', 'DISPID_SLWPronunciations',
    'DISPID_SABIBufferSize', 'SPEI_WORD_BOUNDARY', 'SPPS_Modifier',
    'eLEXTYPE_MORPHOLOGY', 'IEnumString', 'SPSUnknown',
    'DISPID_SRCreateRecoContext', 'SVP_0',
    'DISPID_SPRuleNumberOfElements', 'DISPID_SOTCDefault',
    'SPPS_Verb', 'DISPID_SOTSetId', 'SPPS_RESERVED2',
    'DISPID_SpeechPhraseAlternates', 'ISpObjectToken',
    'DISPID_SGRSTText', 'SPSLMA', 'SpPhoneConverter',
    'SpeechUserTraining', 'ISpeechRecoResultDispatch',
    'DISPID_SRRecognizer', 'SpeechVoiceSkipTypeSentence',
    'DISPID_SPRFirstElement', 'SPRST_INACTIVE_WITH_PURGE',
    'DISPID_SGRsCount', 'ISpeechResourceLoader', 'eWORDTYPE_DELETED',
    'DISPID_SDKGetlongValue', 'SPSERIALIZEDRESULT',
    'DISPID_SOTCategory',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet', 'SPLO_STATIC',
    'SpeechFormatType', 'SPPS_RESERVED4', 'SpeechInterference',
    'DISPID_SRCCreateGrammar', 'SAFT8kHz16BitMono',
    'eLEXTYPE_PRIVATE17', 'DISPID_SRCERecognition',
    'SpeechVisemeType', 'DISPID_SDKEnumValues', 'SPWT_LEXICAL',
    'ISpeechPhraseRules', 'SRERequestUI',
    'DISPID_SPIGetDisplayAttributes', 'DISPID_SPACommit',
    'SPDKL_CurrentConfig', 'SPWAVEFORMATTYPE', 'SVEAllEvents',
    'SpCompressedLexicon', 'SpeechAudioVolume',
    'DISPID_SRRAudioFormat', 'SPWORDPRONOUNCEABLE',
    'DISPID_SPEAudioStreamOffset', 'SpeechTokenValueCLSID',
    'DISPID_SOTGetAttribute', 'DISPID_SOTIsUISupported',
    'SPINTERFERENCE_NONE', 'DISPID_SLWsCount',
    'DISPID_SDKGetStringValue', 'SPSHT_OTHER',
    'DISPID_SLPPartOfSpeech', 'DISPID_SRCResume',
    'SPDKL_DefaultLocation', 'SPGRAMMARWORDTYPE',
    'DISPID_SpeechPhraseRules', 'SPPHRASERULE', 'ISpeechRecognizer',
    'SPEVENTENUM', 'DISPID_SASNonBlockingIO', 'ISpeechFileStream',
    ...
    'DISPID_SPEEngineConfidence', 'DISPID_SPRuleEngineConfidence',
    'SVEWordBoundary', 'SPDATAKEYLOCATION',
    'IInternetSecurityMgrSite', 'SGLexical', 'eLEXTYPE_PRIVATE20',
    'SREPropertyNumChange', 'SAFT32kHz8BitStereo',
    'DISPID_SPPConfidence', 'ISpeechGrammarRule', 'DISPID_SRCPause',
    'SpeechWordType', 'SpeechTokenContext', 'SpeechRecognitionType',
    'DISPID_SBSFormat', 'DISPID_SGRsCommitAndSave',
    'DISPID_SRCRecognizer', 'SDTDisplayText', 'SVP_11', 'SGDisplay',
    'DISPID_SVEViseme', 'DISPID_SPEActualConfidence',
    'DISPID_SRRSetTextFeedback', 'DISPID_SpeechPhraseRule',
    'SAFT16kHz16BitMono', 'SPBINARYGRAMMAR', 'STCLocalServer',
    'STCRemoteServer', 'DISPID_SVAlertBoundary', 'SPVPRIORITY',
    'DISPID_SpeechRecoContextEvents',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'SAFTCCITT_ALaw_22kHzStereo', 'DISPID_SGRSTRule',
    'SREInterference', 'DISPID_SGRSRule', 'ISpeechAudio',
    'ISpRecoContext2', 'tagSPPROPERTYINFO',
    'SAFTCCITT_ALaw_11kHzMono', 'SPSNoun', 'SPPS_Unknown',
    'DISPID_SLPsItem', 'SPRST_ACTIVE_ALWAYS', 'SpPhraseInfoBuilder',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SpeechGrammarTagDictation',
    'DISPID_SOTGetDescription', 'ISpeechAudioStatus',
    'SPPHRASEELEMENT', 'SVSFParseAutodetect',
    'SpeechDisplayAttributes', 'SpeechRecoEvents', 'SPSHORTCUTTYPE',
    ...
    'SVEBookmark', 'SpeechAudioFormatGUIDText', 'SVP_5',
    'SPSHORTCUTPAIRLIST', 'SPEI_RESERVED2', 'ISpeechMMSysAudio',
    'DISPID_SGRSAddRuleTransition', 'SRADynamic',
    'SpeechAudioFormatType', 'SWTDeleted',
    'DISPID_SWFEAvgBytesPerSec', 'SpUnCompressedLexicon',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'DISPID_SpeechGrammarRules',
    'DISPID_SREmulateRecognition', 'SPVOICESTATUS',
    'ISpObjectTokenCategory', 'ISpeechPhraseProperties',
    'DISPID_SPRuleChildren', 'DISPID_SpeechRecoResultTimes',
    'DISPID_SRStatus', 'DISPID_SVWaitUntilDone', 'DISPID_SFSClose',
    'SDTRule', 'DISPID_SPANumberOfElementsInResult', 'DISPID_SLPType',
    'DISPID_SPRuleConfidence', 'SAFT11kHz8BitMono', 'SPPROPERTYINFO',
    'DISPID_SRRSpeakAudio', 'DISPID_SpeechPhoneConverter',
    'DISPID_SpeechXMLRecoResult', 'DISPID_SRSetPropertyString',
    'DISPID_SOTId', 'SASClosed', 'SVPOver', 'SVP_10',
    '_ISpeechRecoContextEvents', 'DISPID_SVSCurrentStreamNumber',
    'SPWT_PRONUNCIATION', 'SP_VISEME_10', 'SVF_Stressed',
    'SVEVoiceChange', 'ISpObjectWithToken', 'DISPID_SpeechVoice',
    'SREHypothesis', 'SAFT12kHz16BitStereo', 'SP_VISEME_2',
    'ISpGrammarBuilder', 'eLEXTYPE_LETTERTOSOUND', 'SPVPRI_NORMAL',
    'SpeechTokenShellFolder', 'SRTEmulated', 'SPEI_END_SR_STREAM',
    'SPEI_RESERVED5', 'SPAR_Low', 'DISPID_SLWs_NewEnum',
    'ISpeechPhraseReplacements', 'Speech_Default_Weight',
    'SPAS_CLOSED', 'ISpeechPhraseAlternates',
    'SpeechCategoryAppLexicons', 'SAFTCCITT_uLaw_22kHzMono',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SAFTGSM610_11kHzMono',
    'SPEI_RECO_OTHER_CONTEXT', 'DISPID_SVSLastBookmarkId',
    'SP_VISEME_19', 'DISPID_SPIRetainedSizeBytes', 'ISpRecoCategory',
    'DISPID_SVPriority', 'ISpProperties', 'SPAUDIOSTATE', 'SPWORD',
    'SPSEMANTICFORMAT', 'DISPID_SPIAudioSizeBytes', 'DISPID_SAFType',
    'SAFTTrueSpeech_8kHz1BitMono', 'SAFTADPCM_11kHzMono',
    'SpeechEngineProperties', 'DISPID_SRCEBookmark',
    'SPPS_Noncontent', 'SpWaveFormatEx', 'DISPID_SDKGetBinaryValue',
    'eLEXTYPE_PRIVATE18', 'DISPID_SVSInputSentencePosition',
    'SPFM_OPEN_READONLY', 'SGDSActiveUserDelimited',
    'ISpeechRecognizerStatus', 'ISpeechGrammarRuleState',
    'SP_VISEME_14', 'DISPID_SPIEnginePrivateData', 'DISPID_SAVolume',
    'ISpeechLexiconPronunciations', 'DISPID_SRCEHypothesis',
    'DISPID_SVIsUISupported', 'DISPID_SPERetainedSizeBytes',
    'DISPID_SDKEnumKeys', 'SPPS_Noun', 'ISpeechWaveFormatEx',
    'DISPID_SPEDisplayText', 'DISPID_SpeechRecoResult',
    'DISPID_SLWWord', 'SPEI_SOUND_START', 'SPRS_INACTIVE',
    'SPCT_COMMAND', 'DISPID_SPIProperties',
    'SAFTCCITT_uLaw_8kHzStereo', 'DISPID_SAFGuid', 'DISPID_SRGId',
    'DISPID_SVEPhoneme', 'SP_VISEME_17', 'SVEAudioLevel',
    'SGRSTTTextBuffer', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'SpeechWordPronounceable', 'ISpeechPhraseElement',
    'ISpNotifyTranslator', 'DISPID_SRCEFalseRecognition',
    'SDKLLocalMachine', 'DISPID_SPRulesCount',
    'DISPID_SpeechPhraseElement', 'SDKLCurrentUser',
    'SpeechLexiconType', 'eLEXTYPE_PRIVATE14',
    'SWPUnknownWordPronounceable', 'DISPID_SVSRunningState',
    'DISPID_SVEVoiceChange', 'DISPID_SpeechVoiceStatus',
    'ISpeechDataKey', 'SPWF_SRENGINE', 'SAFTCCITT_uLaw_44kHzStereo',
    'eLEXTYPE_PRIVATE2', 'eLEXTYPE_PRIVATE12',
    'SGLexicalNoSpecialChars', 'DISPIDSPTSI',
    'SpeechEmulationCompareFlags', 'DISPID_SPIEngineId', 'SRAExport',
    'ISpRecoGrammar', 'SPXRO_Alternates_SML', 'SPEI_UNDEFINED',
    'SGSEnabled', 'Speech_StreamPos_Asap', 'SVEViseme',
    'SpeechRegistryLocalMachineRoot', 'DISPID_SRGRules',
    'SREAudioLevel', 'DISPID_SRCEPropertyNumberChange',
    'DISPID_SVSVisemeId', 'eWORDTYPE_ADDED', 'SpObjectToken',
    'SpMMAudioIn', 'DISPID_SGRSTType', 'SPEI_TTS_PRIVATE',
    'ISpRecoGrammar2', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'SGDSInactive', 'ISpeechGrammarRuleStateTransitions',
    'DISPID_SPRNumberOfElements', 'SVP_4',
    'DISPID_SVSpeakCompleteEvent', 'DISPID_SVAudioOutputStream',
    'DISPID_SRCCmdMaxAlternates', 'SP_VISEME_7',
    'DISPID_SGRSTNextState', 'SpInProcRecoContext', 'SSFMOpenForRead',
    'DISPID_SVEAudioLevel', 'SECNormalConfidence', 'SPCONTEXTSTATE',
    'SVSFIsXML', 'SECFIgnoreCase', 'STCInprocHandler',
    'DISPID_SRCRetainedAudioFormat', 'DISPID_SDKSetLongValue',
    'SAFT22kHz8BitStereo', 'SITooQuiet', 'DISPID_SRGetFormat',
    'DISPID_SRCEPhraseStart', 'DISPID_SpeechPhraseReplacement',
    'SVP_14', 'SPEI_PHONEME', 'SpeechRetainedAudioOptions',
    'DISPID_SRSNumberOfActiveRules',
    'DISPID_SLRemovePronunciationByPhoneIds', 'WAVEFORMATEX',
    'DISPID_SASFreeBufferSpace', 'DISPID_SVEventInterests',
    'SECFNoSpecialChars', 'eLEXTYPE_RESERVED6', 'DISPID_SVSpeak',
    'eLEXTYPE_VENDORLEXICON', 'DISPID_SpeechFileStream',
    'SPEI_FALSE_RECOGNITION', 'DISPID_SLGetPronunciations',
    'SPLO_DYNAMIC', 'DISPID_SRRTimes', 'SP_VISEME_12', 'SP_VISEME_15',
    'DISPID_SRRTTickCount', 'SAFT24kHz8BitMono', 'SPEI_SR_BOOKMARK',
    'SBONone', 'SPSHT_NotOverriden',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SAFTGSM610_8kHzMono',
    'SDTReplacement', 'SREStateChange', 'DISPID_SRCERequestUI',
    'SPINTERFERENCE', 'SPXRO_SML', 'DISPID_SBSWrite',
    'eLEXTYPE_USER_SHORTCUT', 'DISPID_SpeechPhraseProperty',
    'DISPID_SLPsCount', 'SVP_12', 'DISPID_SOTCGetDataKey',
    'DISPID_SRCERecognizerStateChange',
    'DISPID_SVSLastStreamNumberQueued', 'eLEXTYPE_PRIVATE1', 'SVP_17',
    'SECFIgnoreWidth', 'DISPID_SPRuleFirstElement',
    'SpeechRecoContextState', 'DISPID_SPRsItem', 'DISPID_SOTsCount',
    'DISPID_SMSADeviceId', 'SSTTWildcard', 'SPEI_SENTENCE_BOUNDARY',
    'SVP_1', 'DISPID_SASState', 'SDTAll', 'SAFT8kHz8BitStereo',
    'SAFTCCITT_uLaw_8kHzMono', 'SDA_No_Trailing_Space',
    'SPWORDPRONUNCIATIONLIST', 'SREFalseRecognition', 'SLODynamic',
    'DISPID_SPAsCount', 'SpStream', 'DISPID_SOTsItem',
    'Speech_StreamPos_RealTime', 'SpeechVisemeFeature',
    'ISpEventSink', 'Speech_Max_Pron_Length', 'ISpLexicon',
    'SRESoundStart', 'DISPID_SVEBookmark', 'SpeechAudioState',
    'DISPID_SPRText', 'SRERecoOtherContext', 'SP_VISEME_20',
    'DISPID_SGRSTPropertyValue', 'DISPID_SPIAudioSizeTime',
    'ISpEventSource', 'SPDKL_CurrentUser', 'SPSFunction',
    'SAFTCCITT_uLaw_44kHzMono', 'DISPID_SABIEventBias',
    'SPPS_RESERVED3', 'SITooFast', 'SPWF_INPUT',
    'DISPID_SPCIdToPhone', 'SPSHT_EMAIL',
    'DISPID_SpeechGrammarRuleStateTransition', 'DISPID_SVAudioOutput',
    'DISPID_SRGSetWordSequenceData', 'DISPID_SRIsShared',
    'eLEXTYPE_USER', 'SFTSREngine', 'DISPID_SpeechLexiconWords',
    'DISPID_SRGDictationLoad', 'SVP_13',
    'DISPID_SPAStartElementInResult', 'SRAONone', 'SPEI_RESERVED1',
    'SRSEIsSpeaking', 'eLEXTYPE_PRIVATE15', 'SVP_21',
    'DISPID_SPIStartTime', 'SLTUser', 'STSF_CommonAppData',
    'eLEXTYPE_PRIVATE10', 'SVP_15', 'DISPID_SPRDisplayAttributes',
    'SVP_20', 'SPINTERFERENCE_NOSIGNAL', 'DISPID_SpeechAudioFormat',
    'SPSMF_UPS', 'SPAR_Medium', 'STCAll',
    'DISPID_SOTCEnumerateTokens', 'SVESentenceBoundary',
    'SAFT16kHz8BitStereo', 'SRATopLevel', 'ISpeechPhraseRule',
    'DISPID_SVSInputSentenceLength', 'SWTAdded', 'SRADefaultToActive',
    'DISPID_SWFEBlockAlign', 'SpeechAddRemoveWord',
    'DISPID_SGRAddState', 'SAFT12kHz8BitStereo', 'DISPID_SLPSymbolic',
    'SECLowConfidence', 'ISpeechObjectTokenCategory', 'SPGS_ENABLED',
    'SVP_9', 'DISPID_SVSLastBookmark',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'ISpeechBaseStream',
    'DISPID_SBSRead', 'SAFT32kHz16BitMono',
    'SpeechRecoProfileProperties', 'SPEI_RESERVED6',
    'DISPID_SPEsCount', 'SVP_2',
    'SpeechPropertyLowConfidenceThreshold', 'DISPID_SPIGrammarId',
    'SpeechBookmarkOptions', 'DISPID_SRGCommit',
    'IInternetSecurityManager', 'DISPID_SPILanguageId',
    ...
    '_RemotableHandle', 'SPPS_SuppressWord', 'DISPID_SRCEAudioLevel',
    'eLEXTYPE_PRIVATE7', 'DISPID_SOTRemove', 'eLEXTYPE_PRIVATE6',
    'DISPID_SMSGetData', 'SpeechPropertyAdaptationOn',
    'DISPID_SABufferNotifySize', 'SpInprocRecognizer', 'SPSVerb',
    'SpVoice', 'SAFTCCITT_ALaw_44kHzMono',
    'DISPID_SRGIsPronounceable', 'SPEI_RESERVED3',
    'DISPID_SRRAlternates', 'DISPID_SRGCmdSetRuleState',
    'DISPID_SRGetPropertyString', 'SPEI_INTERFERENCE',
    'SpeechGrammarTagWildcard', 'SpeechDictationTopicSpelling',
    'DISPID_SABufferInfo', 'SPBO_AHEAD', 'ISpeechRecoResult2',
    'SpeechRecognizerState', 'DISPID_SRRTOffsetFromStart',
    'DISPID_SPEPronunciation', 'SRAInterpreter',
    'DISPID_SpeechBaseStream', 'SAFTADPCM_44kHzMono',
    'ISpeechRecoResult', 'SpMMAudioEnum', 'SPEI_HYPOTHESIS',
    'SPEI_MIN_SR', 'ISpPhrase', 'SpeechRuleAttributes',
    'DISPID_SVGetProfiles', 'SpeechCategoryAudioOut',
    'SpeechGrammarWordType', 'SPGS_EXCLUSIVE',
    ...
    'SAFT44kHz16BitStereo', 'DISPID_SVGetAudioOutputs',
    'SpeechAllElements', 'SPEVENT', 'ISpeechAudioFormat',
    'SDTAlternates', 'DISPID_SGRSAddSpecialTransition',
    'SpeechGrammarState', 'SDKLDefaultLocation', 'SP_VISEME_16',
    'STSF_LocalAppData', 'SAFT48kHz8BitMono',
    'DISPID_SGRSTPropertyId', 'DISPID_SpeechPhraseElements',
    'SAFTADPCM_8kHzStereo', 'SRSActiveAlways', 'tagSTATSTG',
    'ISpNotifySink', 'DISPID_SRGCmdLoadFromFile', 'SpFileStream',
    'SPSNotOverriden', 'SGRSTTWord', 'DISPID_SWFEChannels',
    'DISPID_SVEStreamStart', 'DISPID_SPPName', 'DISPID_SPRsCount',
    'SREPropertyStringChange', 'SRTAutopause', 'SPAR_Unknown',
    'SPPS_Interjection', 'ISpeechPhraseReplacement',
    'SPPS_NotOverriden', 'DISPID_SRRGetXMLResult',
    'SSSPTRelativeToStart', 'DISPID_SASCurrentSeekPosition',
    'SRERecognition', 'ISpeechVoice', 'DISPID_SRProfile',
    'eLEXTYPE_APP', 'SPPS_Function', 'DISPID_SpeechPhraseProperties',
    'DISPID_SPIRule', 'SAFTADPCM_44kHzStereo', 'SPEI_MIN_TTS',
    'DISPID_SpeechAudioBufferInfo', 'SVEEndInputStream', 'LONG_PTR',
    'SPEI_VOICE_CHANGE', 'DISPID_SPRules_NewEnum',
    'DISPID_SRSClsidEngine', 'Speech_Max_Word_Length', 'SINoSignal',
    'DISPID_SPERetainedStreamOffset', 'SBOPause',
    'SDA_Two_Trailing_Spaces', 'SITooLoud', 'DISPID_SOTDataKey',
    'DISPID_SPPValue', 'SREStreamStart', 'eLEXTYPE_PRIVATE5',
    'SPEI_RECOGNITION', 'SVSFParseSsml', 'DISPID_SRCEventInterests',
    'SpeechCategoryVoices', 'SPSModifier', 'SRESoundEnd',
    'SpSharedRecoContext', 'SRSActive', 'SGRSTTDictation',
    'ISpeechGrammarRules', 'DISPID_SGRSTsItem', 'DISPID_SOTs_NewEnum',
    'SAFTADPCM_11kHzStereo', 'SPINTERFERENCE_TOOFAST',
    'SPINTERFERENCE_LATENCY_WARNING',
    'DISPID_SRCERecognitionForOtherContext', 'DISPID_SRGState',
    'DISPID_SRRPhraseInfo', 'DISPID_SRCVoice', 'DISPID_SGRSTWeight',
    'SP_VISEME_5', 'SVEStartInputStream', 'DISPID_SGRAddResource',
    'SITooSlow', 'DISPID_SPPNumberOfElements',
    'DISPID_SpeechObjectTokens', 'DISPID_SpeechRecoContext',
    'SPWT_DISPLAY', 'SAFT12kHz8BitMono', 'DISPID_SpeechPhraseBuilder',
    'DISPID_SpeechObjectToken', 'DISPID_SRCState', 'DISPID_SVStatus',
    'DISPID_SVSInputWordPosition', 'SPCS_ENABLED',
    'SpeechPropertyResponseSpeed', 'DISPID_SDKCreateKey', 'SPAS_RUN',
    'DISPID_SVRate', 'SRSInactiveWithPurge', 'SVP_18', 'SVP_8',
    'SAFTCCITT_ALaw_11kHzStereo', 'SDKLCurrentConfig', 'SAFTDefault',
    'ISpXMLRecoResult', '_SPAUDIOSTATE', 'SPBO_NONE',
    'SpeechVoiceCategoryTTSRate', 'SWPKnownWordPronounceable',
    'SVPNormal', 'SPCT_SUB_DICTATION', 'SLTApp', 'DISPID_SGRId',
    'SpeechRegistryUserRoot', 'DISPID_SLPs_NewEnum', 'ISpRecognizer2',
    'SINoise', 'SAFTCCITT_ALaw_8kHzStereo', 'SAFTNonStandardFormat',
    'DISPID_SVResume', 'SpAudioFormat', 'SP_VISEME_11',
    'SVSFPurgeBeforeSpeak', 'SAFT11kHz8BitStereo',
    'DISPID_SRRGetXMLErrorInfo', 'DISPID_SPPs_NewEnum',
    'SPSSuppressWord', 'ISpeechVoiceStatus', 'DISPID_SVEWord',
    'DISPID_SVESentenceBoundary', 'SAFT22kHz16BitStereo',
    'DISPID_SRCRetainedAudio', 'SREAdaptation', 'SP_VISEME_13',
    'SpMemoryStream', 'SSTTDictation', 'DISPID_SpeechAudio',
    'DISPID_SRRRecoContext', 'DISPID_SDKSetStringValue',
    'DISPID_SWFEExtraData', 'DISPID_SRRTStreamTime',
    'SSFMOpenReadWrite', 'SPAR_High', 'SAFTNoAssignedFormat',
    'SPAO_RETAIN_AUDIO', 'DISPID_SVGetVoices',
    'DISPID_SRGetRecognizers', 'SGRSTTEpsilon', 'ISpeechLexicon',
    'ISpeechPhoneConverter', 'SAFT48kHz16BitMono',
    'eLEXTYPE_PRIVATE3', 'SPEI_SR_AUDIO_LEVEL', 'SLOStatic',
    'SAFTCCITT_uLaw_11kHzMono', 'DISPID_SRCRequestedUIType',
    'SAFTGSM610_44kHzMono', 'DISPID_SPIAudioStreamPosition',
    'ISequentialStream', 'eLEXTYPE_PRIVATE16', 'SVSFlagsAsync',
    'SRAImport', 'SPPS_LMA', 'SpCustomStream', 'DISPID_SVSLastResult',
    'DISPID_SBSSeek', 'DISPID_SWFEFormatTag', 'SPRST_INACTIVE',
    'DISPID_SOTCSetId', 'SpeechRuleState',
    'DISPID_SRSCurrentStreamPosition', 'DISPID_SpeechPhraseInfo',
    'SAFT12kHz16BitMono', 'SRTSMLTimeout', 'DISPID_SGRSTs_NewEnum',
    'DISPID_SRRAudio', 'ISpeechMemoryStream', 'SPAS_PAUSE',
    'SVSFUnusedFlags', 'DISPID_SGRsDynamic', 'DISPID_SAStatus',
    'Library', 'SPEVENTSOURCEINFO', 'DISPID_SDKDeleteKey',
    'ISpeechRecoContext', 'SPRST_ACTIVE', 'ISpMMSysAudio',
    'SPSMF_SAPI_PROPERTIES', 'SVF_None', 'ISpeechObjectTokens',
    'SRTExtendableParse', 'STCInprocServer', 'DISPID_SRCESoundEnd',
    'SpeechCategoryAudioIn', 'SpeechSpecialTransitionType',
    'SRTReSent', 'SAFT24kHz16BitStereo', 'SVEPrivate',
    'DISPID_SRGDictationUnload', 'SpeechRunState', 'SPGS_DISABLED',
    'SpeechCategoryPhoneConverters', 'ISpeechPhraseInfoBuilder',
    'SPSEMANTICERRORINFO', 'SPGRAMMARSTATE', 'eLEXTYPE_PRIVATE19',
    'ISpeechLexiconPronunciation', 'DISPID_SPRuleName',
    'DISPID_SWFEBitsPerSample', 'SSFMCreate', 'SPRULE',
    'DISPID_SGRSAddWordTransition', 'SPWORDLIST', 'ISpeechPhraseInfo',
    'DISPID_SLPLangId', 'DISPID_SpeechRecoResult2', 'DISPID_SRGReset',
    'IEnumSpObjectTokens', 'SGPronounciation', 'SPAUDIOOPTIONS',
    'SAFT32kHz8BitMono', 'DISPID_SGRSTransitions',
    'DISPID_SGRSTsCount', 'SPFM_OPEN_READWRITE',
    'ISpStreamFormatConverter', 'DISPID_SVSPhonemeId',
    'DISPID_SPAPhraseInfo', 'SP_VISEME_8', 'eLEXTYPE_PRIVATE13',
    '_ISpeechVoiceEvents', 'DISPID_SPIElements', 'DISPID_SRState',
    'SpeechCategoryRecognizers', 'SPADAPTATIONRELEVANCE',
    'DISPID_SVVolume', 'STSF_FlagCreate', 'DISPID_SPRuleId',
    'DISPID_SPRuleParent', 'SPSERIALIZEDPHRASE', 'SPFILEMODE',
    ...
    'SpNotifyTranslator', 'DISPID_SPPsCount', 'ISpRecognizer3',
    'DISPID_SRCVoicePurgeEvent', 'SECHighConfidence', 'ISpAudio',
    'SpNullPhoneConverter', 'ISpeechPhraseProperty',
    'DISPID_SPEDisplayAttributes', 'SAFTCCITT_ALaw_44kHzStereo',
    'SpeechTokenKeyUI', 'SPEI_START_INPUT_STREAM', 'SVP_6',
    ...
    'ISpeechObjectToken', 'DISPID_SMSSetData', 'SPPHRASEREPLACEMENT',
    'DISPID_SGRAttributes', 'DISPID_SpeechLexiconWord', 'IStream',
    'DISPID_SVSkip', 'DISPID_SLAddPronunciation', 'SGSDisabled',
    'DISPID_SRSAudioStatus', 'SPFM_CREATE', 'DISPID_SPAsItem',
    'DISPID_SADefaultFormat', 'ISpSerializeState', 'SpMMAudioOut',
    'DISPID_SGRInitialState', 'SpeechStreamFileMode',
    'SPXMLRESULTOPTIONS', 'SAFTExtendedAudioFormat', 'SPVPRI_ALERT',
    '__MIDL_IWinTypes_0009', 'eLEXTYPE_RESERVED10',
    'SpeechVoicePriority', 'SP_VISEME_1', 'DISPID_SLWType',
    'DISPID_SRDisplayUI', 'SpeechTokenIdUserLexicon', 'SPRS_ACTIVE',
    'SVP_7', 'SREPrivate', 'SAFTCCITT_ALaw_22kHzMono',
    'SPINTERFERENCE_TOOQUIET', 'SPWORDTYPE', 'SPEI_REQUEST_UI',
    'DISPID_SGRsFindRule', 'DISPID_SRGetPropertyNumber',
    'SECFDefault', 'SPINTERFERENCE_TOOSLOW', 'SP_VISEME_4',
    'DISPID_SOTCId', 'SVSFDefault', 'SPRS_ACTIVE_USER_DELIMITED',
    'DISPID_SPARecoResult', 'DISPID_SDKOpenKey',
    'DISPID_SASCurrentDevicePosition', 'SVP_16',
    'ISpeechLexiconWords', 'SAFTADPCM_22kHzMono', 'DISPID_SMSALineId',
    'DISPID_SLGetWords', 'SPRECOGNIZERSTATUS',
    'DISPID_SRCCreateResultFromMemory', 'SPTEXTSELECTIONINFO',
    'SASRun', 'SP_VISEME_18', 'SPEI_END_INPUT_STREAM', 'SPBO_PAUSE',
    'SPSHT_Unknown', 'DISPID_SASetState', 'DISPID_SPELexicalForm',
    'DISPID_SGRsItem', 'SPCT_SLEEP', 'SpeechTokenKeyFiles',
    'DISPID_SpeechWaveFormatEx', 'SPLEXICONTYPE', 'SRSEDone',
    'ISpShortcut', 'SpeechEngineConfidence', 'SPVPRI_OVER',
    'ISpDataKey', 'DISPID_SpeechMMSysAudio', 'DISPID_SRCESoundStart',
    'ISpResourceManager', 'SPEI_PROPERTY_STRING_CHANGE'
]

_check_version('1.4.1', 1759549711.104898)
